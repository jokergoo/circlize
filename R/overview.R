...
#
# Current there are following functions that can be used for plotting: `circos.points`,
# `circos.lines`, `circos.rect`, `circos.polygon`, `circos.text`, `circos.axis` and `circos.link`. 
# 
# For drawing points, lines and text through the whole track (among several sectors), the following
# functions are available: `circos.trackPoints`, `circos.trackLines` and `circos.trackText`.
#
