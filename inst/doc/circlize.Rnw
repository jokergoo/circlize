...
Sector allocation is determined by {\tt circos.initialize} and track allocation is determined by {circos.trackPlotRegion}
...
if do not set factor argument, or it is not a facotr...
