...
x-range from 0 to 1 and y-range from 0 to 1 by default.
...
circos only contains a half (figure 12).
...
distribution of data (figure 13). So users would know how to implement those
