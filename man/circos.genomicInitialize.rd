...
\details{
  The function will initialize circos plot from genomic data. If \code{plotType} is set with value in \code{axis} or \code{labels}, there will create a new track.  
