...
\arguments{
  \item{data}{A bed-file-like data frame or a \code{GRanges} object. It can also be a list containing data frames and/or \code{GRanges} objects.}
  ...
  \item{numeric.column}{Columns of numeric values in \code{data} that will be used for plotting.  If it is from a \code{GRanges} object, its value start from meta-columns. If \code{data} is a data frame list, \code{numeric.column} should be either length of one or length of \code{data}. If value of \code{numeric.column} is not set, its value will be inferred from \code{data}.}
