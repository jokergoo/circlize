...
\arguments{
  ...
  \item{direction}{Direction of the text, should be one of \code{c("default", "vertical_left", "vertical_right", "horizontal", "arc")}. How to choose text direction can be found in the vignette.}
