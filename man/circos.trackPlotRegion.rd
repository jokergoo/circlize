...
\details{
  This function pretends to be a high-level plotting function, which means,  you must first call this function to create a plotting region, then those low-level graphical function such as \code{\link{circos.points}}, \code{\link{circos.lines}} can be applied.  
