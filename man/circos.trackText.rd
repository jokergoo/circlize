...
\details{
  The function adds texts in multiple cells by first splitting data into several parts in whicheach part corresponds to one factor (sector index) and then add texts in cells correspondingto the part of data by calling \code{\link{circos.text}}.
