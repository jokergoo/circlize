...
\details{
  The function is a simple wrapper of \code{get.cell.meta.data("sector.index")} and should only be put inside \code{panel.fun} when using \code{\link{circos.genomicTrackPlotRegion}}. 
