...
<<circlize_text_easy, echo = FALSE, out.width = "0.6\\textheight", out.height = "0.9\\textheight", fig.cap = "Human easy text facing. When {\\tt niceFacing} is on, settings in upper two figures or bottom two are actually identical. Red dots represent positions of the texts.">>=
