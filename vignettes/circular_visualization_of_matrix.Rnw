...
chordDiagram(mat, grid.col = grid.col, link.sort = FALSE)
chordDiagram(mat, grid.col = grid.col, link.sort = TRUE)
chordDiagram(mat, grid.col = grid.col, link.sort = FALSE, link.decreasing = TRUE)
