...
Final figure is figure \ref{fig:phylogenetic}. Once you know the basic rule for drawing such circular
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{phylogenetic-tree.pdf}
