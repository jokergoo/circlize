...
We would show you how to use {\tt circlize} package to draw some rather interesting
graphcis.
...
drawn about one thousand years ago. The width of the original painting is 528 cm
...
information for each pixel in the figure; 2. use {\tt circos.rect} to draw
