...
circos.text(5, 9, "type = 's'", sector.index = "d", facing = "outside")
...
circos.lines(sort(runif(10)*10), runif(10)*8, sector.index = "h", area = TRUE, baseline = "top")
circos.text(5, 1, "type = 'l', area = TRUE\nbaseline = 'top'", sector.index = "h")
circos.clear()
par(cex = 1)